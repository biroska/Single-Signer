...
public class DebtssummariesApiServiceImpl extends DebtssummariesApiService {
    @Override
    public Response retrieveDebtsSummaries(String contentType, String authorization, Long companyId, SecurityContext securityContext)
